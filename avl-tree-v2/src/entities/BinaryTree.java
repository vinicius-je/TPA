...
public class BinaryTree<T extends Comparable<T>> {
    ...
    protected Node<T> insert(Node<T> current, Node<T> newNode){
        ...
        if(current == null){
            ...
            current.setHeight(current.calculateHeight());
        }else{
    ...
    private T searchElement(T target){
        ...
        while(current != null){
            //elemento encontrado.
            if(comp.compare(current.getValue(), target) == 0){
                System.out.println("\tElemento: " + current.getValue() + " - Altura: " + current.getHeight());
    ...
    public void statistic(){
        ...
        System.out.println("\tAltura da arvore: " + this.height());
        System.out.println("\tRaiz: " + root.getValue() + " - Altura: " + root.getHeight());
        Node<T> smallest = this.smallest();
        Node<T> biggest = this.biggest();
        System.out.println("\tMenor elemento: " + smallest.getValue() + " - Altura: " + smallest.getHeight());
        System.out.println("\tMaior elemento: " + biggest.getValue() + " - Altura: " + biggest.getHeight());
    }
